...
const VegFood = () => {
  ...
  useEffect(() => {
    const getRecipes = async () => {
      try {
        const data = await axios.get(`${baseURL}api/recipes?category=Non-Veg`);
      ...
      <div>
        ...
        <div className="flex flex-row">
          ...
          <div className="m-5 text-3xl  flex-1 h-15 shadow  ">
            <h2 className=" mt-1 pl-4">NonVeg Recipe</h2>
            <button className="btn mt-10">Add NonVeg-Food</button>
          </div>
